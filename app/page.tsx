...
export default function Page() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-background text-foreground pb-20 md:pb-0">
      ...
      <section className="premium-showcase"><div className="site-shell grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20"><div className="premium-showcase-image" role="img" aria-label="A Hire a Wifey helper styling a bright coastal kitchen" /><div><p className="eyebrow">The premium difference</p><h2>Beautifully cared for, <em>down to the details.</em></h2><p className="large-copy">From the first hello to the final folded towel, every visit is thoughtful, discreet and tailored to your home.</p><div className="premium-facts"><div><strong>4.9/5</strong><span>average client rating</span></div><div><strong>2,400+</strong><span>homes helped locally</span></div><div><strong>100%</strong><span>carefully matched</span></div></div><a className="text-link" href="#enquire">Experience the difference <ArrowRight size={16} /></a></div></div></section>
